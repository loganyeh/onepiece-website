    ...
    return(
        <>
            <div className="min-h-screen bg-gray-50">
                ...
                {/* Card Preview */}
                <div className="fixed flex justify-center items-center inset-0 bg-amber-200/50">
                {/* <div className="fixed border-2 border-red-600 inset-0 bg-amber-200/40"> */}

                    {/* Exit X */}
                    <i className='bx bx-x p-0.5 fixed top-0 right-0 bg-yellow-900 text-white text-5xl' ></i>

                    <div className="mx-2.5 w-full max-w-5xl flex flex-col gap-5 bg-white">
                        ...
                        <div className="mx-6 flex-1 aspect-[3/4.25] bg-blue-300 rounded-2xl" style={{ backgroundImage: `url(${""})`}}></div>

                        {/* Left and Right Arrow */}
                        <i className='bx bxs-left-arrow fixed w-fit left-0 top-1/2 p-2 text-white text-sm bg-yellow-900 rounded-full' ></i>
                        <i className='bx bxs-right-arrow fixed w-fit right-0 top-1/2 p-2 text-white text-sm bg-yellow-900 rounded-full' ></i>

                        <div className="mx-12 mb-5 px-2 py-2 flex bg-yellow-900 text-white rounded-full">
